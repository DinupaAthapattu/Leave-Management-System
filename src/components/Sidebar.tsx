...
//             <Link
//               to="/admin"
//               className={`flex items-center gap-3 px-4 py-2 hover:bg-primary-hover ${isActive('/admin')}`}
//             >
...
//             <Link
//               to="/history"
//               className={`flex items-center gap-3 px-4 py-2 hover:bg-primary-hover ${isActive('/history')}`}
//             >
//               <Clock size={20} />
...
//             <Link
//               to="/employee"
//               className={`flex items-center gap-3 px-4 py-2 hover:bg-primary-hover ${isActive('/employee')}`}
//             >
//               <User2 size={20} />
//               {!collapsed && 'Employees'}
//             </Link>
