...
const EmployeeDashboard = () => {
  ...
  return (
    <DashboardLayout>
      <h1 className="text-2xl md:text-3xl font-bold text-heading mb-2">Hi, Dinupa 👋</h1>
      <p className="text-blue-800 mb-6">Welcome to your employee dashboard</p>

      {/* Leave Request Form */}
      <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-10">
        <h2 className="text-lg sm:text-xl font-semibold text-primary mb-4">Request New Leave</h2>
        ...
        <button
          onClick={handleRequestSubmit}
          className="mt-6 bg-primary hover:bg-primary-hover text-white px-6 py-2 rounded-md transition w-full sm:w-auto"
        >
          Submit Request
        </button>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
          <h2 className="text-lg sm:text-xl font-semibold text-primary">Your Leave History</h2>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border border-border min-w-[640px]">
            <thead>
              <tr className="bg-accent text-heading">
                <th className="p-2 border-b border-border">Date Range</th>
                <th className="p-2 border-b border-border">Type</th>
